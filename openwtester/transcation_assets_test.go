...
func TestTransfer_TDEX(t *testing.T) {

	addrs := []string{
		"0x384ae795e7c4607d520ff46a31141905b8d3b1e1",
		"0xa0c39e196eeb6175a8840913bef9ae31d19cd872",
		"0xb6291381dd4e2d7167d447747782b0c526c5cbbd",
		"0xc2fac7abef086af64f150bfdce615bbf36d4336b",
		"0xda75424d2e57b333feb4271d35337099747acf55",
		"0xdbe52dfb4141dfc4a4ca78bc2338e5ec7eee6359",
	}
...
func TestSummary_TDEX(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "WBGYxZ6yEX582Mx8mGvygXevdLVc7NQnLM"
	accountID := "9EfTQiMEaKSMd1CjxMXRMMxukrwckxdBZpiEkS2B3avD"
